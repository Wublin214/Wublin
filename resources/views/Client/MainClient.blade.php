...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Страница​ заказов&nbsp;для&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;фрилансеров​">
    <meta name="description" content="">
    <title>Разработчики</title>
    <link rel="stylesheet" href="{{asset('css/nicepage.css')}}" media="screen">
    <link rel="stylesheet" href="{{asset('css/MainClient.css')}}" media="screen">
    ...
    <meta property="og:title" content="Разработчики">
...
<body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="ru"><header class="u-clearfix u-header u-header" id="sec-c976"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="#" class="u-image u-logo u-image-1" data-image-width="873" data-image-height="727">
            <img src="{{asset('storage/images/Desktop_240603_1728.png')}}" class="u-logo-image u-logo-image-1" alt="">
        </a>
    ...
    <section class="u-clearfix u-section-1" id="sec-be19">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="body u-border-2 u-border-custom-color-1 u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-opacity u-opacity-80 u-white u-group-1"
                 onclick="redirectToOrderView({{ $element->id }})">

                <div class="u-container-layout u-container-layout-1" style="max-width: 100%; overflow: hidden;">
                    <p class="body u-custom-font u-font-montserrat u-text u-text-default u-text-1">{{$element->ProjectTitle}} </p>
                    <p class="u-custom-font u-font-montserrat u-text u-text-default u-text-2">{{$element->Budget}} </p>
                    <p class="" style="width: 100%; margin: 0; padding: 0; box-sizing: border-box; overflow-wrap: break-word; white-space: normal;">{{$element->ProjectDescription}} </p>


                    <div id="hidden-block-{{$element->id}}" style="display: none;">{{$element->id}}</div>
                </div>
